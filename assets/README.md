...
新增素材以扁平目录形式放在 `assets/` 根目录，文件名与 `assets/annotations.json` 对应。
请按清单添加 `*.png.base64` 或生成后的 `.png` 文件，再运行：
...
- `assets/batches/batch1/manifest.json`
- `assets/batches/batch2/manifest.json`
- `assets/batches/batch3/manifest.json`
